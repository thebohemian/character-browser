...
class KotlinSteps(
    ...
    fun character_is_shown(name: String) {
        composeRuleHolder.composeRule.waitUntilAtLeastOneExists(hasText(name), 7_500)
    ...
    fun i_scroll_to_character(name: String) {
        val list = composeRuleHolder.composeRule.onNodeWithTag("characterPreviewList", useUnmergedTree = true)
